...
public class VideoTienda
{
    ...
    public VideoTienda( int unaTarifa )
    {
    	...
    	if (unaTarifa <=0) {
    		throw new IllegalArgumentException("La tarifa del alquiler debe ser mayor que 0");
    	}
    ...
    /**
     * Busca la pelicula dado el título
    ...
    /**
     * Agrega una copia de la pelicula original identificada por el título. <br>
     * <br> post: </b> Si existe la pelicula, se podrá agregar una copia de esta
    ...
    /**
     * Modifica la tarifa de alquiler de la pelicula. <br>
     *<b> post: </b> Si hay tarifas actuales, modificar el precio de esta tarifa
    ...
    {
    	return new ArrayList<>(this.catalogo);
    }
